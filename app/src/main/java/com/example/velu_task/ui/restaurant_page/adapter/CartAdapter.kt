...
class CartAdapter(private val starterList: ArrayList<StarterModel>) :
...
class CartViewHolder(val binding: ItemStarterBinding) : RecyclerView.ViewHolder(binding.root)